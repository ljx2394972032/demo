 ...
 */
public class ResponseMoreEntity implements Serializable {
    ...
    public ResponseMoreEntity(Builder builder) {
    ...
    public static class Builder {
        ...
        public ResponseMoreEntity build() {
            return new ResponseMoreEntity(this);
        }
    }
}