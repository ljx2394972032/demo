...
public class WechatTransferController {
    ...
    private static final Logger LOG = Logger.getLogger(WechatTransferController.class);
    ...
    public void transferPay(HttpServletRequest request, HttpServletResponse response, String openid, String callback) {
        ...
        try {
            ...
            parm.put("partner_trade_no", MakeOrderNum.makeOrderNum()); //商户订单号
        ...
        if (CollectionUtil.isNotEmpty(restmap) && "SUCCESS".equals(restmap.get("result_code"))) {
            ...
            WebUtil.response(response, WebUtil.packJsonp(callback, JSON.toJSONString(new JsonResult(-1, "转账失败", new ResponseData()), SerializerFeatureUtil.FEATURES)));
        }
    }
